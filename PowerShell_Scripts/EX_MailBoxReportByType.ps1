#D:\Mukund\E\RPRWyatt\VSTrunk\PowerShell_POC\PSPOC1\bin\Debug\Scripts\EX_MailBoxReportByType.ps1 -mailBoxType UserMailbox
#.\MailBoxReportQ.ps1 -mailBoxType RoomMailbox
#.\EX_MailBoxReportByType.ps1 -mailBoxType EquipmentMailbox

##Measure-Command {.\MailBoxReportByType.ps1 -mailBoxType UserMailbox }
param(
   [Parameter(ParameterSetName='mailBoxType')] [string]$mailBoxType
)

$report = @()

$sortedStats = Get-Mailbox -ResultSize Unlimited -RecipientTypeDetails $mailBoxType  | Get-MailboxStatistics | Sort-Object TotalItemSize -Descending| Select-Object DisplayName, RecipientTypeDetails, ServerName, Database, TotalDeletedItemSize,ItemCount,LastLogonTime, `
