<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotesEdit.aspx.cs" Inherits="CustomerTracking.NotesEdit" %>
...
<Paddings Padding="0px" PaddingLeft="2px" PaddingTop="0px" PaddingRight="2px" PaddingBottom="7px"></Paddings>
                ...
                <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Date:" CssClass="lblsmallFont">
                                                ...
                                                <td>
                                                    <dx:ASPxDateEdit ID="NCDateEdit" runat="server" Width="170px">
                                                    <ValidationSettings>
                                                ...
                                                <td>
                                                    <dx:ASPxMemo ID="NCDetailTextbox" runat="server" Height="71px" Width="170px">
                                                    </dx:ASPxMemo>
                                                    <%--<dx:ASPxTextBox ID="NCDetailTextbox" runat="server" Width="170px" TextMode="Multiline">
                                                        <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
