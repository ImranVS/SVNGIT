<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TicketsSearch.aspx.cs" Inherits="CustomerTracking.TicketsSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxRoundPanel ID="SearchTicketsRoundPanel" runat="server" Width="100%"
    CssPostfix="Glass" HeaderText="Search Tickets" Theme="Office2003Blue">
...
<Paddings PaddingBottom="0px" PaddingLeft="2px" PaddingTop="0px"></Paddings>
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                ...
                <td class="style2">
                    ...
                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Ticket Number" CssClass="lblsmallFont">
                    </dx:ASPxLabel>
                </td>
                <td>
                ...
                <td class="style2">
                    ...
                    <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Status" CssClass="lblsmallFont">
                    </dx:ASPxLabel>
                </td>
                <td>
                    <dx:ASPxTextBox ID="StatusTextbox" runat="server" Width="170px">
                    </dx:ASPxTextBox>
                    </td></tr>
                    <tr>
                    <td class="style2">
                        ...
                        <dx:ASPxButton ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Search" 
                         Theme="Office2003Blue" Width="80px">
                        </dx:ASPxButton>
                         &nbsp;&nbsp;
                        </div>
                    </td>
    ...
    <dx:ASPxGridView ID="TicketSearchGridView" runat="server" 
                            ...
                            EnableTheming="True" OnPageSizeChanged="TicketsGridView_PageSizeChanged">
                            <Columns>
