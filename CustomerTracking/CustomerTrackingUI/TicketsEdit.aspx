<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TicketsEdit.aspx.cs" Inherits="CustomerTracking.TicketsEdit" %>
...
<Paddings Padding="0px" PaddingLeft="2px" PaddingTop="0px" PaddingRight="2px" PaddingBottom="7px"></Paddings>
                ...
                <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Date:" CssClass="lblsmallFont">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td>
                                                    <dx:ASPxDateEdit ID="TDateEdit" runat="server" Width="170px">
                                                    <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
                                                    </dx:ASPxDateEdit>
                                                    <%--<dx:ASPxTextBox ID="TDateTextbox" runat="server" Width="170px">
                                                        <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
                                                ...
                                                <td>
                                                    ...
                                                    <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Ticket Number:" CssClass="lblsmallFont">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td>
                                                    <dx:ASPxTextBox ID="TicketNumberTextbox" runat="server" Width="170px">
                                                        <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
                                                ...
                                                <tr>
                                                    ...
                                                    <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Details:" CssClass="lblsmallFont">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td>
                                                    <dx:ASPxMemo ID="TicketDetailsTextbox" runat="server" Height="71px" Width="170px">
                                                    </dx:ASPxMemo>
                                                    <%--<dx:ASPxTextBox ID="TicketDetailsTextbox" runat="server" Width="170px">
                                                        <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
                                                ...
                                                <td>
                                                    ...
                                                    <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Status:" CssClass="lblsmallFont">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td>
                                                    <dx:ASPxTextBox ID="TicketStatusTextbox" runat="server" Width="170px">
                                                        <ValidationSettings>
                                                            <RequiredField IsRequired="True" />
                                                            <RequiredField IsRequired="True"></RequiredField>
                                                        </ValidationSettings>
