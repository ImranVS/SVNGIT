...
{
    public partial class ImportExchangeServers4 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Security/ImportExchangeServers.aspx", false);//Mukund, 05Aug14, VSPLUS-844:Page redirect on callback
            Context.ApplicationInstance.CompleteRequest();
        }
