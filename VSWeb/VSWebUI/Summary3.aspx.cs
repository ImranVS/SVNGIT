...
namespace VSWebUI
{
    public partial class Summary3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            GetServers();

            ASPxGridView1.DataSource = VSWebBL.DashboardBL.DashboardBL.Ins.GetStatusGrid("Domino");
        ...
        protected void GetServers()
        {
            try
            {
                DataTable dt = VSWebBL.DashboardBL.DashboardBL.Ins.GetServerType("Domino");
