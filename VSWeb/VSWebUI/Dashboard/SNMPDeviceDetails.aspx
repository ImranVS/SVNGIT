<%@ Page Title="VitalSigns Plus - Domino Server Details Page" Language="C#" MasterPageFile="~/DashboardSite.Master"
    AutoEventWireup="true" CodeBehind="SNMPDeviceDetails.aspx.cs" Inherits="VSWebUI.Configurator.SNMPDeviceDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--<ul id="ContentPlaceHolder1_ASPxPageControl1_TC" class="dxtc-strip dxtc-stripContainer"
        style="width: 0; height: 0px; visibility: hidden; padding: 0px; margin: 0px;
        background-repeat: no-repeat; background-position: 0px 0px; padding-left: 0px;">
    ...
    <table width="100%">
        <tr>
            ...
            <td valign="top" align="right">
                <dx:ASPxMenu ID="ASPxMenu1" runat="server" ShowAsToolbar="True" OnItemClick="ASPxMenu1_ItemClick"
        ...
        <tr>
            <td colspan="3">
                ...
                <div id="SuccessMsg" class="alert alert-success" runat="server" style="display: none">
                    Temporarily Suspended monitoring
                    <button type="button" class="close" data-dismiss="alert">
                        <span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                </div>
            </td>
                ...
                <table id="FeedBackTable" class="EditorsTable" style="width: 100%; height: 100%;">
                    ...
                    <tr>
                        <td class="Label" colspan="2">
                            <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="You may temporarily suspend monitoring for a maximum duration of two hours. If you need to suspend monitoring for more than two hours, please use the Maintenance window functionality in VitalSigns Configurator.">
                            </dx:ASPxLabel>
                        </td>
                    </tr>
                    <tr>
