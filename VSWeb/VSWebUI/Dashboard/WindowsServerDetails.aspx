<%@ Page Title="VitalSigns Plus - Windows Server Details page" Language="C#" MasterPageFile="~/DashboardSite.Master" AutoEventWireup="true"
    CodeBehind="WindowsServerDetails.aspx.cs" Inherits="VSWebUI.Dashboard.WindowsServerDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<%--<table>
        <tr>
            <td>
                <asp:Label ID="lblServerType" runat="server" Text="Windows Server: " Font-Bold="True"
	...
	<table width="100%">
				...
				<table>
					<tr>
						<td>
							...
							<div class="OK" id="serverstatus" runat="server">OK</div>
							</div>
							</td>
							<td valign="top">
							<div id="NameHolder">
		...
		<tr>
			<td colspan="3">
				<div id="Div2" class="alert alert-danger" runat="server" style="display: none">The settings were not updated
					<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				</div>
				<div id="Div3" class="alert alert-success" runat="server" style="display: none">Temporarily Suspended monitoring
					<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				</div>
			</td>
		</tr>
...
--%>        <tr>
            <td colspan="6">
                <div id="ErrorMsg" class="error" runat="server" style="display: none">
                    The settings were not updated</div>
                <div id="SuccessMsg" class="success" runat="server" style="display: none">
                                    ...
                                    <tr valign="top">
                                        <td>
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <dx:ASPxRoundPanel ID="usersASPxRoundPanel" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css" Visible="false"
