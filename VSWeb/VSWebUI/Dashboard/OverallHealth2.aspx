<%@ Page Title="VitalSigns Plus" Language="C#" MasterPageFile="~/DashboardSite.Master" AutoEventWireup="true"
    CodeBehind="OverallHealth2.aspx.cs" Inherits="VSWebUI.Dashboard.OverallHealth2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxCallbackPanel ID="ASPxCallbackPanel01" runat="server" Height="100%" Width="100%">
        <PanelCollection>
            <dx:PanelContent ID="PanelContent01" runat="server" SupportsDisabledAttribute="True">
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                        ...
                                        </dx:ASPxRoundPanel> <dx:ASPxRoundPanel ID="ASPxRoundPanel2" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                                            CssPostfix="Glass" GroupBoxCaptionOffsetY="-24px" Height="300px" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css"
...
<Paddings PaddingLeft="2px" PaddingTop="0px" PaddingBottom="0px"></Paddings>
                                            ...
                                            <PanelCollection>
                                                <dx:PanelContent ID="PanelContent4" runat="server" SupportsDisabledAttribute="True">
                                                    ...
                                                    <dx:WebChartControl ID="WebChartControl4" runat="server" Height="200px" 
                                                        Width="300px">
                                                        <diagramserializable>
                                                            <cc1:SimpleDiagram>
                                                            </cc1:SimpleDiagram>
