<%@ Page Title="VitalSigns Plus - O365Mail Files" Language="C#" MasterPageFile="~/DashboardSite.Master" AutoEventWireup="true" CodeBehind="O365MailFiles.aspx.cs" Inherits="VSWebUI.O365MailFiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td>
       	...
       	<tr>
		<td>
		<dx:ASPxGridView ID="Office365Grid" runat="server" 
                    AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="ID" 
                   
                    Theme="Office2003Blue" 
                    Width="100%" OnPageSizeChanged="Office365Grid_PageSizeChanged" OnDataBound="DataBound">
                    <Columns>
...
<SettingsBehavior ColumnResizeMode="NextColumn" AutoExpandAllGroups="True"></SettingsBehavior>
		...
		<tr>
            <td>
                <dx:ASPxGridViewExporter ID="ServerGridViewExporter" GridViewID="Office365Grid" runat="server">
