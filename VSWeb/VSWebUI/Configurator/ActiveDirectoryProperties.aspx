<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ActiveDirectoryProperties.aspx.cs" Inherits="VSWebUI.Configurator.ActiveDirectoryProperties" %>
...
/* 10/29/2014 NS added for VSPLUS-1044 */
/* The style below is a hack, it's a known issue with DevExpress https://www.devexpress.com/Support/Center/Question/Details/B253048 */
.dxtc-noSpacing
{
    overflow: auto;
...
<table width="100%">
        <tr>
            <td>
                <div class="header" id="lblServer" runat="server">Windows - Active Directory</div>
        <asp:Label ID="lblServerId" runat="server" Font-Bold="True" Font-Size="16pt" 
        ForeColor="Black" Text="Windows- Active Directory" Visible="false"></asp:Label> 
            </td>
        ...
        <tr>
            <td colspan="2">
            <asp:UpdatePanel ID="PanelControl2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
							...
							<ContentCollection>
                                ...
                                <dx:ASPxCallback ID="cb" runat="server" ClientInstanceName="cb" OnCallback="cb_callback" />
												<dx:ASPxGridView ID="ServicesGrid" runat="server" 
                                                    ...
                                                    Width="100%" OnHtmlDataCellPrepared="ServicesGrid_HtmlDataCellPrepared" OnPageSizeChanged="WindowsGridView_PageSizeChanged" >
                                                    <Columns>
