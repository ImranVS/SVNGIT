<%@ Page Title="VitalSigns Plus - Active Directory" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ActiveDirectoryGrid.aspx.cs" 
Inherits="VSWebUI.Configurator.ActiveDirectoryGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <div class="header" id="servernamelbldisp" runat="server">Windows - Active Directory</div>
        </td>
    </tr>
    <tr><td>
        <%--<dx:ASPxRoundPanel runat="server" GroupBoxCaptionOffsetY="-24px" Height="50px" HeaderText="Windows Servers"
                ...
                <table width="100%">--%>
                   <div id="successDiv" class="alert alert-success" runat="server" style="display: none">Success.
                            ...
                            <dx:ASPxGridView runat="server" KeyFieldName="ID" AutoGenerateColumns="False"
                                Width="100%" ID="GenericGridView" OnPageSizeChanged="GenericGridView_PageSizeChanged" 
                                
            OnHtmlRowCreated="GenericGridView_HtmlRowCreated" Cursor="pointer" 
...
<Paddings Padding="3px"></Paddings>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Name" FieldName="ServerName"
                                      ...
                                      <Settings AutoFilterCondition="Contains" AllowAutoFilterTextInputTimer="False" />
                                       ...
                                       <%-- <PropertiesHyperLinkEdit NavigateUrlFormatString="WindowsProperties.aspx?Key={0}" Target="_self"
...
<CellStyle CssClass="GridCss"></CellStyle>
									...
									<%--<dx:GridViewDataCheckColumn Caption="DAG"
                                        VisibleIndex="7" Width="60px" FieldName="ScanDagHealth">
                                        <Settings AllowAutoFilter="False" />
                                        <EditCellStyle CssClass="GridCss">
                                        </EditCellStyle>
                                        <EditFormCaptionStyle CssClass="GridCss">
