<%@ Page Title="VitalSigns Plus - Cloud Applications Server Properties" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="CloudApplicationsServerProperties.aspx.cs"
    Inherits="VSWebUI.Configurator.CloudApplicationsServerProperties" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td valign="top">
                <div class="header" id="servernamelbldisp" runat="server">Cloud Applications</div>
            </td>
            ...
            <td colspan="2">
                <dx:ASPxPageControl Font-Bold="True" ID="ASPxPageControl1" runat="server" ActiveTabIndex="0"
                    ...
                    CssPostfix="Glass" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css"
                                ...
                                <TabPages>
                                    <dx:TabPage Text="Server Properties">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                                                                ...
                                                                Width="100%" HeaderText="Cloud Applications Server Attributes">
                                                                            ...
                                                                            <tr>
                                                                              <td style="width:100px" valign="top">
                                                                                    <asp:Image ID="Image1" runat="server" 
                                                                                        ImageUrl="~/images/Cloud_Apps/123.jpg" Height="75px" Width="99px" />
                                                                                </td>
                                                                                ...
                                                                                <td valign="top">
                                                                                    <table width="50%">
                                                                                        <tr>
                                                                                            <td>
                                                                                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" CssClass="lblsmallFont" Text="Name:">
                                                                                    </dx:ASPxLabel>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxTextBox ID="IPAddressTextBox" runat="server" Width="170px">
                                                                                        <ValidationSettings ErrorDisplayMode="None">
                                                                                            <RegularExpression ErrorText="Address validation failed" 
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td rowspan="2" valign="top">
                                                                                    <asp:Label ID="Label1" runat="server" CssClass="lblsmallFont" Text="If you entered a value into the Search Text box, then VitalSigns will try to locate this text on the CloudApplicationsServer page and if it can’t find it, an alert will be generated."></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                    ...
                                                                    <dx:PanelContent ID="PanelContent5" runat="server" SupportsDisabledAttribute="True">
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxTextBox ID="UserNameTextBox" runat="server" Width="170px" autocomplete="off" AutoCompleteType="Disabled">
                                                                                        <ValidationSettings ErrorDisplayMode="None">
                                                                                        </ValidationSettings>
                                                                                    </dx:ASPxTextBox>
                                                                                </td>
                                                                                <td rowspan="2" valign="top">
                                                                                    <asp:Label ID="Label2" runat="server" CssClass="lblsmallFont" Text="If you entered values in the Username and Password fields, then VitalSigns will try to use these credentials on the CloudApplicationsServer page and if the credentials fail, an alert will be generated."></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
    ...
    <dx:ASPxPopupControl ID="ErrorMessagePopupControl" runat="server" AllowDragging="True"
        ...
        Width="300px" Theme="MetropolisBlue">
                    ...
                    <ContentCollection>
                        ...
                        <dx:ASPxTextBox runat="server" Width="170px" ID="txtSearch" 
        Visible="False">
<ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
</dx:ASPxTextBox>

                        <dx:ASPxLabel runat="server" 
        Text="Search Text  (optional):" CssClass="lblsmallFont" ID="ASPxLabel16" 
