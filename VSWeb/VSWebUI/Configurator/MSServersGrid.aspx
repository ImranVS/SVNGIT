<%@ Page Title="VitalSigns Plus - Exchange Servers" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="MSServersGrid.aspx.cs" Inherits="VSWebUI.Configurator.MSServersGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <div class="header" id="lblServer" runat="server">Microsoft Exchange Servers</div>
        </td>
    </tr>
    <tr><td>
                ...
                <table width="100%">--%>
                   <div id="successDiv" class="alert alert-success"  runat="server" style="display: none">Success.
                            ...
                            <dx:ASPxGridView runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                ...
                                Width="100%" ID="MSServerGridView" OnPageSizeChanged="MSServerGridView_PageSizeChanged" 
                                
            OnHtmlRowCreated="ExchangeServerGridView_HtmlRowCreated" Cursor="pointer" 
...
<CellStyle CssClass="GridCss"></CellStyle><Settings AutoFilterCondition="Contains" AllowAutoFilterTextInputTimer="False" />
</dx:GridViewDataTextColumn>
