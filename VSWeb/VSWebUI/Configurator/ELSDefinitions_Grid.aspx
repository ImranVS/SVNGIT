<%@ Page Title="VitalSigns Plus - Event Log Definitions" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ELSDefinitions_Grid.aspx.cs" Inherits="VSWebUI.ELSDefinitions_Grid" %>
    ...
    <script type="text/javascript">
		...
		function OnCustomButtonClick(s, e) {
			...
			if (e.buttonID == "deleteButton")
			    ELSDefGridView.GetRowValues(e.visibleIndex, 'Name', OnGetRowValues);
			...
			function OnGetRowValues(values) {
				...
				if (OK == true) {
				    ELSDefGridView.DeleteRow(visibleIndex);
				}
			}
		}
   </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>
                <div class="header" id="servernamelbldisp" runat="server">Windows Event Definitions</div>
            </td>
        </tr>
        <tr><td>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ELSDefGridView" runat="server" AutoGenerateColumns="False" 
                    KeyFieldName="ID" ClientInstanceName="ELSDefGridView"
                    OnHtmlDataCellPrepared="ELSDefGridView_HtmlDataCellPrepared" 
                    OnHtmlRowCreated="ELSDefGridView_HtmlRowCreated" 
                    OnRowDeleting="ELSDefGridView_RowDeleting" Width="100%" OnPageSizeChanged="ELSDefGridView_PageSizeChanged"
