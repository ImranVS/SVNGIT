...
{
    public partial class WindowsProperties : System.Web.UI.Page
    {
        bool isValid = true;
            ...
            try
            {
                ...
                */
                ...
                if (ReturnValue.ToString() == "True")
                {
                    ...
                    Response.Redirect("~/Configurator/WindowsServerGrid.aspx", false);//Mukund, 05Aug14, VSPLUS-844:Page redirect on callback
		...
		protected void ASPxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
		{
			...
			if (Request.QueryString["ID"] != "" && Request.QueryString["ID"] != null)
			{
				...
				if (dt.Rows.Count > 0)
				{
					Response.Redirect("~/Dashboard/WindowsServerDetails.aspx?Name=" + dt.Rows[0]["ServerName"].ToString() + "&Type=" + dt.Rows[0]["Type"].ToString() + "&Status=" + dt.Rows[0]["Status"].ToString() + "&LastDate=" + dt.Rows[0]["LastUpdate"].ToString(), false);
					Context.ApplicationInstance.CompleteRequest();
				}
			}
        ...
        protected void OKCopy_Click(object sender, EventArgs e)
        {
            ...
            {
                check = VSWebBL.SecurityBL.webspehereImportBL.Ins.Insertpwd(AliasName.Text, UserID.Text, encryptedpasasstring,16);
