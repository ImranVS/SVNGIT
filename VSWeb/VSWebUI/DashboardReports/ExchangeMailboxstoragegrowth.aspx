<%@ Page Title="VitalSigns Plus - Exchange Mailbox storage growth" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="ExchangeMailboxstoragegrowth.aspx.cs" Inherits="VSWebUI.ExchangeMailboxstoragegrowth" %>
            ...
            onclick="ResetButton_Click" CssClass="sysButton">
                         ...
                         <tr>
                            <td>
                             <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                <dx:ASPxRadioButtonList ID="DatabasesServersRadioButton" runat="server" 
                                 RepeatDirection="Horizontal" SelectedIndex="0" onselectedindexchanged="DatabasesServersRadioButton_SelectedIndexChanged"  AutoPostBack="true"
                                    >
                                    <Items>
                                        <dx:ListEditItem Selected="True" Text="Databases" Value="Databases" />
                        ...
                        <td>
                          <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <dx:ASPxComboBox ID="DocumentComboBox" runat="server" AutoPostBack="true" Theme="Default">
                                    </dx:ASPxComboBox>
                     </ContentTemplate>
                            <%--    <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ResetButton" />
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="lblsmallFont" 
                                    Text="(will filter the report by Mailbox storage above the entered value)">
                                </dx:ASPxLabel>
