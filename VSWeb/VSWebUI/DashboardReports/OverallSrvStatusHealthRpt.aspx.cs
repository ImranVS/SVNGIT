...
{
    public partial class OverallSrvStatusHealthRpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            DashboardReports.OverallSrvStatusHealthXtraRpt report = new DashboardReports.OverallSrvStatusHealthXtraRpt();
