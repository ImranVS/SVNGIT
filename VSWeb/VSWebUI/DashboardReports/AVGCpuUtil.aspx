<%@ Page Title="VitalSigns Plus - Average CPU utilization per day" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="AVGCpuUtil.aspx.cs" Inherits="VSWebUI.WebForm6" %>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="lblsmallFont" 
                                    Text="(will filter the report by CPU above the entered value)">
                                </dx:ASPxLabel>
