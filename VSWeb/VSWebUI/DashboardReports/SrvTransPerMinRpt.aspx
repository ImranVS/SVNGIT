<%@ Page Title="VitalSigns plus - SrvTransPerMinRpt" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="SrvTransPerMinRpt.aspx.cs" Inherits="VSWebUI.DashboardReports.SrvTransPerMinRpt" %>
   ...
   <style type="text/css">
    ...
    <table>
        ...
        <table>
                    ...
                    <tr>
                        <td valign="top">
                            <input name="startDate" id="startDate" runat="server" class="date-picker" />
                        </td>
                    </tr>
                </table>
            </td>
