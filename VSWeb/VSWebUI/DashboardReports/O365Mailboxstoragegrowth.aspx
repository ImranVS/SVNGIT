<%@ Page Title="VitalSigns Plus - Office365 Mailbox storage growth" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="O365Mailboxstoragegrowth.aspx.cs" Inherits="VSWebUI.O365Mailboxstoragegrowth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <dx:ASPxButton ID="ResetButton" runat="server" Text="Reset" 
            onclick="ResetButton_Click" CssClass="sysButton">
                      ...
                      <%--    <tr>
                        <td>
                            <dx:ASPxComboBox ID="MailComboBox" runat="server"  SelectedIndex="0"
                         Theme="Default" 
                         AutoPostBack="true"
                       >
                    </dx:ASPxComboBox>
