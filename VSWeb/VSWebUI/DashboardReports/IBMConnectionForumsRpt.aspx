<%@ Page Language="C#" Title="VitalSigns Plus - Exchange Messages" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="IBMConnectionForumsRpt.aspx.cs" Inherits="VSWebUI.DashboardReports.IBMConnectionForumsRpt" %>
                ...
                <td class="tdpadded" valign="top">
                    ...
                    <table>
                        ...
                        <tr>
                           ...
                           <tr>
                        <td class="style1">
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Forums:" CssClass="lblsmallFont">
                            </dx:ASPxLabel>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                            <dx:ASPxComboBox ID="ForumsTypeComboBox" runat="server"  ValueType="System.String" onselectedindexchanged="ForumsTypeComboBox_SelectedIndexChanged">
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
