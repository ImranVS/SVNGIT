<%@ Page Language="C#" Title="VitalSigns Plus - IBM Connections Profiles" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="IBMConnectionsProfiles.aspx.cs" Inherits="VSWebUI.DashboardReports.IBMConnectionsProfiles" %>
            ...
            <tr>
                <td class="tdpadded" valign="top">
                    ...
                    <table>
                     ...
                     <td>
                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Profiles:" CssClass="lblsmallFont">
                                </dx:ASPxLabel>
                            </td>
                            </tr>
                              <tr>
                     <td>
                              <dx:ASPxComboBox ID="ProfilesCombobox" runat="server" onselectedindexchanged="ProfilesCombobox_SelectedIndexChanged"   AutoPostBack="true">
