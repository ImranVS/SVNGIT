<%@ Page Title="VitalSigns Plus - Traveler HTTP sessions" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="TravelerHTTPsessions.aspx.cs" Inherits="VSWebUI.TravelerHTTPsessions" %>
                       ...
                       <tr>
                            <td valign="top">
                                ...
                                <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="lblsmallFont" 
                                    Text="(will filter the report by HTTP sessions above the entered value)">
                                </dx:ASPxLabel>
    ...
    <dx:ReportToolbar ID="ReportToolbar1" runat="server" ShowDefaultButtons="False" 
        ...
        <Styles>
            ...
            <Margins MarginLeft="3px" MarginRight="3px" />
                        ...
                        <tr>
                            <td>
    <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="DashboardReports.LicenseXtraReport">
