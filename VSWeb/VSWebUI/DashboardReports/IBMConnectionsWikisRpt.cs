...
{
    public partial class IBMConnectionsWikisRpt : DevExpress.XtraReports.UI.XtraReport
    {//11-04-2016 Durga Modified for VSPLUS-2829
        public IBMConnectionsWikisRpt()
        {
            InitializeComponent();
        }

        private void IBMConnectionsWikisRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)

        {
            DataTable dt = new DataTable();
            dt = VSWebBL.ReportsBL.ReportsBL.Ins.GetIBMConnectionstatsInfo(this.ServerName.Value.ToString(), this.WikiType.Value.ToString(), 
