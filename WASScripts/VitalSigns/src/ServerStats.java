...
public class ServerStats {
	...
	private void getHeapStats(String nodeName, String serverName) throws Exception {
		...
		try {
			...
			srvDisplayName;
			com.ibm.websphere.management.configservice.ConfigDataId nodeID,
			srvID;
					...
					if (ststats != null) {
						for (Statistic stst: ststats) {
							try {
								...
								System.out.println("Exception in loop for threadPoolStats. Error : " + ex.getMessage());
							}
						}
					}
