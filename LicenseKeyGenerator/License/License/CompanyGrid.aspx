<%@ Page Title="VitalSigns Plus - Maintain Users" Language="C#" MasterPageFile="~/Site1.Master"
	AutoEventWireup="true" CodeBehind="CompanyGrid.aspx.cs" Inherits="License.CompanyGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<tr>
			<td>
				<div id="successDiv" runat="server" class="alert alert-success" style="display: none">
					Company Name were successully updated.
	...
	<dx:ASPxGridView runat="server" KeyFieldName="ID" AutoGenerateColumns="False" ID="UsersGridView"
		...
		OnRowUpdating="UsersGridView_RowUpdating" Width="40%"  ClientInstanceName="UsersGridView"
		OnCellEditorInitialize="UsersGridView_CellEditorInitialize" OnRowCommand="UsersGridView_RowCommand"
		Theme="Office2003Blue" OnInitNewRow="UsersGridView_InitNewRow" OnPageSizeChanged="CompanyGrid_PageSizeChanged" OnBeforeGetCallbackResult="UsersGridView_BeforeGetCallbackResult">
		...
		<Columns>
			...
			<dx:GridViewCommandColumn Caption="Delete" ButtonType="Image" VisibleIndex="0" Visible="false">
				<CustomButtons>
					<dx:GridViewCommandColumnCustomButton ID="deleteButton" Image-Url="../images/delete.png" />
				</CustomButtons>
				<HeaderStyle CssClass="GridCssHeader" />
			</dx:GridViewCommandColumn>
			<dx:GridViewDataTextColumn FieldName="CompanyName" VisibleIndex="1" Width="15%">
