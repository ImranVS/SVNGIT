<%@ Page Title="VitalSigns Plus - LicenseExpiringReport" Language="C#" MasterPageFile="~/Site1.Master"
	AutoEventWireup="true" CodeBehind="LicenseExpiryReport.aspx.cs" Inherits="License.LicenseExpiringReport" %>
	...
	<tr>
			<td>
				<div class="header" id="servernamelbldisp" runat="server">
					License Expiry Report</div>
			</td>
		</tr>
<tr>
<td>
	<dx:ASPxGridView runat="server" KeyFieldName="ID" Width="95%" AutoGenerateColumns="False" ID="LicenceReportGridView"
