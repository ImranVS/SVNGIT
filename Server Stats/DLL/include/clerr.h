...
#define ERR_SERVER_NOT_FOUND			PKG_CLIENT+3
	errortext(ERR_SERVER_NOT_FOUND,		"Unable to find path to server. To trace this connection, use File - Preferences - User Preferences - Ports - Trace (Notes client) or Trace command (Domino server)")
...
#define ERR_NO_UDF_CONN_REC				PKG_CLIENT+47
	errortext(ERR_NO_UDF_CONN_REC,	 	"You can not get UDF information from a pre-R7 server")
