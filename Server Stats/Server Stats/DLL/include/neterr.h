...
#define STR_RQST1B_LIST						(PKG_NETWORK5+30)
	stringtext(STR_RQST1B_LIST,				"SCR_RQST|DB2_RELOCATE_CONT_RQST|DB2_UDF_NOTE_UPDATE_RQST|GETSET_FOLDERINFO_RQST|ID_EXTRA_RQST|JS_GETSCHED_RQST|LOG_SEARCHR6_MSG_RQST|GETCHANGEDDBS_RQST|DB_MODIFIEDTIME_BYNAME_RQST")
