...
#if defined(OSF) || (defined(NT) && defined(_ALPHA_)) || defined(LINUX) || defined(SOLARIS) || defined(MAC)
#include <stdarg.h>
...
#endif
#endif
#elif defined(OSF)  || defined(LINUX) || (defined(NT) && defined(_ALPHA_)) || defined(MAC)
#define VARARG_START(_AP,_LASTNAMEDARG) \
