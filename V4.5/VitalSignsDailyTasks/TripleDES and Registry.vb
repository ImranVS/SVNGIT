...
Public Class XMLOperation
    ...
    Public Function ReadFromXML(ByVal strSetting As String, ByVal strNode As String)
        Dim xml_doc As New Xml.XmlDocument, strType As String = "", strValue As Object
        Dim str1() As String
...
Public Class RegistryHandler
    ...
    Function ReadFromRegistry(ByVal KeyName As String) As Object
        ...
        If objXML.NodeExists(KeyName) = True Then
            Return objXML.ReadFromXML(KeyName, "Value")
        Else
...
End Class
Public Class RegistryHandlerOLD
    Sub WriteToRegistry(ByVal KeyName As String, ByVal KeyValue As Object)
        ...
        'Dim myIni As New iniFile(Environment.CurrentDirectory & "\VitalSigns.ini")
        'Try
        '    Dim myValue As String
        '    myValue = CStr(KeyValue)
        '    myIni.WriteString("VitalSigns", KeyName, myValue)
        'Catch ex As Exception
        '    myIni.WriteString("VitalSigns", KeyName, ex.ToString)
        'End Try
    End Sub
    ...
    Function ReadFromRegistry(ByVal KeyName As String) As Object
        ...
        'Dim myIni As New iniFile(Environment.CurrentDirectory & "\VitalSigns.ini")
        'Try
        '    Return myIni.GetString("VitalSigns", KeyName, "")
        'Catch ex As Exception
        '    Return ex.ToString
        '    'myIni.WriteString("VitalSigns", KeyName, ex.ToString)
        'End Try
...
Public Class iniFile
    ...
    Private Declare Ansi Function GetPrivateProfileInt Lib "kernel32.dll" Alias "GetPrivateProfileIntA" (ByVal lpApplicationName As String, _
