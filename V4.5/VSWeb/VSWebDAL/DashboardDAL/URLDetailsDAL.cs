...
{
    public class URLDetailsDAL
    {
        private AdaptorforDsahBoard objAdaptor = new AdaptorforDsahBoard();
     
        private Adaptor adaptor = new Adaptor();
        private static URLDetailsDAL _self = new URLDetailsDAL();

        public static URLDetailsDAL Ins
        {
            get
            {
                return _self;
        ...
        public DataTable SetGraph(string paramGraph, string DeviceName)
        {
            ...
            if (paramGraph == "hh")
            {
                try
                {
                    ...
                    dt = objAdaptor.FetchURLHourlyVals("ResponseTime", System.DateTime.Now, DeviceName);
