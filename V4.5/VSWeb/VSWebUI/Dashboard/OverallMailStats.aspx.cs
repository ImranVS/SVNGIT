...
{
    public partial class OverallMailStats : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["UserPreferences"] != null)
                {
                    ...
                    {
                        if (dr[1].ToString() == "OverallMailStats|ServerStatsGridView")
                        {
        ...
        public void ReloadGrid()
        {
            ...
            if (startDate.Value.ToString() == "")
            {
                date = DateTime.Now.ToString();
                //3/21/3014 NS added
                startDate.Value = DateTime.Now.ToString("MMMM") + " " + DateTime.Now.ToString("yyyy");
            }
            else
            {
            ...
            dt = VSWebBL.DashboardBL.MailHealthBL.Ins.GetMailStats(sname, dtval.Month, dtval.Year, exactmatch);
        ...
        protected void ServerStatsGridView_PageSizeChanged(object sender, EventArgs e)
        {
            ...
            VSWebBL.ConfiguratorBL.UserPreferencesBL.Ins.UpdateUserPreferences("OverallMailStats|ServerStatsGridView", ServerStatsGridView.SettingsPager.PageSize.ToString(), Convert.ToInt32(Session["UserID"]));
        ...
        public static void WriteResponse(HttpResponse response, byte[] filearray, string type)
        {
            ...
            contentDisposition.FileName = "MailStats.pdf";
