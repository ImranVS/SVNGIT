...
{
    public partial class URLDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack && !IsCallback)
            {
                ...
                if (Request.QueryString["Name"] != "" && Request.QueryString["Name"] != null)
                {
                    ...
                    DataTable dt = VSWebBL.ConfiguratorBL.URLsBL.Ins.GetURLDetails(Request.QueryString["Name"]);
                    //9/19/2014 NS added for VSPLUS-934
                    servernamelbldisp.InnerHtml = lblServerType.Text + dt.Rows[0]["TheURL"].ToString() + "(" + Request.QueryString["Name"] + ")";
        ...
        public DataTable SetGraph(string paramGraph, string DeviceName)
        {
            try
            {
                ...
                DataTable dt = VSWebBL.DashboardBL.SNMPServerDetailsBL.Ins.SetGraph(paramGraph, DeviceName);
        ...
        */
        ...
        protected void ASPxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
        {
            ...
            else if (e.Item.Name == "EditConfigItem")
            {
                ...
                if (Request.QueryString["Name"] != "" && Request.QueryString["Name"] != null)
                {
					id = (VSWebBL.ConfiguratorBL.URLsBL.Ins.GetServerIDbyServerName(Request.QueryString["Name"].ToString())).ToString();
                  //  id = (VSWebBL.SecurityBL.ServersBL.Ins.GetServerIDbyServerName(Request.QueryString["Name"].ToString())).ToString();
