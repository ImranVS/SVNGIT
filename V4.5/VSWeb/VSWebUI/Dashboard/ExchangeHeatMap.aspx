<%@ Page Title="VitalSigns Plus - Exchange Server Mail Latency Heat Map" Language="C#" MasterPageFile="~/DashboardSite.Master"
	AutoEventWireup="true" CodeBehind="ExchangeHeatMap.aspx.cs" Inherits="VSWebUI.Dashboard.ExchangeHeatMap" %>
			...
			<td valign="top" align="right">
                    ...
                    <Items>
                        <dx:MenuItem Name="MainItem">
                            <Items>
                                <dx:MenuItem Name="MessageLatencyTest" Text="Message Latency Test">
                                </dx:MenuItem>
												...
												<asp:UpdatePanel ID="EXGServerListUpdatePanel" runat="server" UpdateMode="Conditional">
													<ContentTemplate>
														...
														<dx:ASPxGridView ID="EXGHeatGridView" runat="server" ClientInstanceName="EXGHeatGridView"
															...
															OnHtmlDataCellPrepared="EXGHeatGridView_HtmlDataCellPrepared" EnableTheming="True" >
															<Columns>
															</Columns>
															<Templates>
																<%--  <HeaderCaption>
