<%@ Page Title="VitalSigns Plus - Active Directory Server Details page" Language="C#"
	MasterPageFile="~/DashboardSite.Master" AutoEventWireup="true" CodeBehind="ActiveDirectoryServerDetailsPage3.aspx.cs"
	Inherits="VSWebUI.Configurator.ActiveDirectoryServerDetailsPage3" %>
...
<script type="text/javascript" src="../js/jquery-1.9.1.js"></script>
	...
	<table width="100%">
		<tr>
						...
						<td>
							<div id="StatusHolder">
								<div class="StatusLabel">
									Overall Status</div>
								<div class="OK" id="serverstatus" runat="server">
									OK</div>
							</div>
						</td>
						<td>
							<div id="NameHolder">
								<div class="header" id="servernamelbldisp" runat="server">
									azphxdom1/RPRWyatt</div>
								<div class="scan" id="Lastscanned" runat="server">
									9/16/2014 2:59:00 PM</div>
							</div>
			...
			<td valign="top" align="right">
				<dx:ASPxMenu ID="ASPxMenu1" runat="server" HorizontalAlign="Right" ShowAsToolbar="True"
					OnItemClick="ASPxMenu1_ItemClick1" Style="height: 33px" Theme="Moderno">
														...
														<PanelCollection>
															<dx:PanelContent ID="PanelContent2" runat="server" SupportsDisabledAttribute="True">
                                                                ...
                                                                <cc1:XYDiagram Rotated="True">
                                                                    <axisx visibleinpanesserializable="-1" reverse="True" title-text="Disk Name" title-visible="True" ><label><resolveoverlappingoptions allowhide="False" allowrotate="False" /><resolveoverlappingoptions allowhide="False" allowrotate="False"></resolveoverlappingoptions><resolveoverlappingoptions 
                                                                ...
                                                                <viewserializable><cc1:StackedBarSeriesView></cc1:StackedBarSeriesView></viewserializable>
																	...
																	<tr>
																		<td>
																			<dx:ASPxButton ID="ASPxButton2" runat="server" Theme="Office2003Blue" ToolTip="View Chart">
    ...
    grid.SetVisible(false);
																			...
																			<dx:ASPxButton ID="ASPxButton3" runat="server" Theme="Office2003Blue" ToolTip="View Grid">
																				<ClientSideEvents Click="function(s, e) {
     chartDiskSpace.SetVisible(false);
     grid.SetVisible(true);
}" />
                                                        ...
                                                        <PanelCollection>
                                                            <dx:PanelContent ID="PanelContent16" runat="server" SupportsDisabledAttribute="True">
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td>
                                                                            <dxchartsui:WebChartControl ID="CASUsersChart" runat="server" Height="300px" Width="600px">
                                                                                <diagramserializable>
                                                                            <cc1:XYDiagram PaneLayoutDirection="Horizontal">
											...
											<tr>
												<td id="gridCell">
													<dx:ASPxGridView ID="MonitoredServicesGrid" runat="server" AutoGenerateColumns="False"
														...
														<Columns>
															<dx:GridViewDataTextColumn Caption="Current State" VisibleIndex="2" FieldName="Result"
																Width="200px">
															...
															<dx:GridViewDataTextColumn Caption="Start Mode" FieldName="StartMode" VisibleIndex="3"
																Width="180px">
																<Settings AutoFilterCondition="Contains" AllowDragDrop="True" />
																<EditCellStyle CssClass="GridCss">
																</EditCellStyle>
															...
															<dx:GridViewDataTextColumn Caption="Last Checked" FieldName="DateStamp" VisibleIndex="5"
																Width="180px">
																<Settings AutoFilterCondition="Contains" AllowDragDrop="True" />
																<EditCellStyle CssClass="GridCss">
																</EditCellStyle>
											...
											<tr>
												<td id="Td2">
													<dx:ASPxGridView ID="UnMonitoredServicesGrid" runat="server" AutoGenerateColumns="False"
														CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css" CssPostfix="Office2010Silver"
														Width="100%" Cursor="pointer" KeyFieldName="ID" Theme="Office2003Blue" OnPageSizeChanged="UnMonitoredServicesGrid_PageSizeChanged">
														<SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" ColumnResizeMode="NextColumn">
														</SettingsBehavior>
														<Columns>
															...
															<dx:GridViewDataTextColumn Caption="Current State" VisibleIndex="1" FieldName="Result"
																Width="200px">
																<Settings AutoFilterCondition="Contains" AllowDragDrop="True" />
																<HeaderStyle CssClass="GridCssHeader" />
																<Settings AllowAutoFilter="False" />
															...
															<dx:GridViewDataTextColumn Caption="Last Checked" FieldName="DateStamp" VisibleIndex="3"
																Width="180px">
																<Settings AutoFilterCondition="Contains" AllowDragDrop="True" />
																<EditCellStyle CssClass="GridCss">
																</EditCellStyle>
											...
											<tr>
												...
												<td align="right" >
													<table>
														<tr>
															<td>
																<dx:ASPxMenu ID="ASPxMenu2" runat="server" EnableTheming="True" HorizontalAlign="Right"
																	OnItemClick="EventSettings_ItemClick" ShowAsToolbar="True" Theme="Moderno" Visible="false">
																	<ClientSideEvents ItemClick="OnItemClick" />
																	<Items>
											...
											<asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
												<ContentTemplate>
													<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
														CssPostfix="Glass" GroupBoxCaptionOffsetY="-24px" HeaderText="Replication Tests"
														...
														<PanelCollection>
															<dx:PanelContent ID="PanelContent5" runat="server" SupportsDisabledAttribute="True">
																<table width="100%">
																	<tr>
																		<td id="Td3">
																			<dx:ASPxGridView ID="ReplicationGridView" runat="server" AutoGenerateColumns="False"
																				CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css" CssPostfix="Office2010Silver"
																				Cursor="pointer" Theme="Office2003Blue" Width="100%">
																				<Columns>
																					<dx:GridViewDataTextColumn Caption="Source Server" FieldName="SourceServer" Visible="true"
																						VisibleIndex="0">
																					</dx:GridViewDataTextColumn>
																					<dx:GridViewDataTextColumn Caption="Largest Delta" FieldName="LargestDelta" ShowInCustomizationForm="True"
																						VisibleIndex="1" Width="200px">
																					</dx:GridViewDataTextColumn>
																					<dx:GridViewDataTextColumn Caption="Number of fails" FieldName="Fails" ShowInCustomizationForm="True"
																						VisibleIndex="3">
																					</dx:GridViewDataTextColumn>
																					<dx:GridViewDataTextColumn Caption="Number of Directory Partitions" FieldName="DirectoryPartitions"
																						VisibleIndex="2" Width="80px">
																					</dx:GridViewDataTextColumn>
																					<dx:GridViewDataTextColumn Caption="Last Scan" FieldName="LastScanTime" ShowInCustomizationForm="True"
																						VisibleIndex="5" Width="150px" Visible="true">
																						<Settings AllowDragDrop="True" AutoFilterCondition="Contains"></Settings>
																					</dx:GridViewDataTextColumn>
																				</Columns>
																				<Settings ShowGroupPanel="True" />
	...
	<dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" AllowDragging="True" AllowResize="True"
		...
		ShowOnPageLoad="False" Width="400px" Height="70px" FooterText="To resize the control use the resize grip or the control's edges"
				...
				<table id="FeedBackTable" class="EditorsTable" style="width: 100%; height: 100%;">
					...
					<tr>
						<td class="Label" colspan="2">
							<dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="You can temporarily suspend the monitoring for a maximum duration of two hours. If you need to suspend monitoring for more than two hours, please use the Maintenance window functionality in VitalSigns Configurator.">
							</dx:ASPxLabel>
						</td>
					</tr>
					<tr>
