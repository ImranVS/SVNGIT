...
{
    public partial class MaintenanceWinRpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ConfiguratorReports.MaintenanceWinXtraRpt report = new ConfiguratorReports.MaintenanceWinXtraRpt();
