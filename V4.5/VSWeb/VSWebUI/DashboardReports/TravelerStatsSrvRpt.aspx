<%@ Page Title ="VitalSigns Plus - TravelerStatsSrvRpt" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="TravelerStatsSrvRpt.aspx.cs" Inherits="VSWebUI.DashboardReports.TravelerStatsSrvRpt" %>
        ...
        <div class="input-prepend">&nbsp;</div>
                <table>
                    ...
                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" 
                        Text="Select a mail server:" CssClass="lblsmallFont">
                    </dx:ASPxLabel>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    <dx:ASPxComboBox ID="ServerFilterComboBox" runat="server" 
                        Theme="Default">
                    </dx:ASPxComboBox>
                        </td>
                    </tr>
