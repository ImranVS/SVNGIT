<%@ Page Language="C#" Title="VitalSigns Plus - IBM Connections Activity" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="IBMConnectionsActivity.aspx.cs" Inherits="VSWebUI.DashboardReports.IBMConnectionsActivity" %>
            ...
            <tr>
                <td class="tdpadded" valign="top">
                    ...
                    <table>
                     ...
                     <td>
                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Activities:" CssClass="lblsmallFont">
                                </dx:ASPxLabel>
                            </td>
                            </tr>
                     ...
                     <tr>
                     <td>
                              <dx:ASPxComboBox ID="ActivityTypeCombobox" runat="server" 
                                  onselectedindexchanged="ActivityTypeCombobox_SelectedIndexChanged">
