...
{
    public partial class IBMConnectionsActivityRpt : DevExpress.XtraReports.UI.XtraReport
    {//11-04-2016 Durga Modified for VSPLUS-2832
        public IBMConnectionsActivityRpt()
        {
            InitializeComponent();
        }

        private void IBMConnectionsActivityRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)


        {
            DataTable dt = new DataTable();
            dt = VSWebBL.ReportsBL.ReportsBL.Ins.GetIBMConnectionstatsInfo(this.ServerName.Value.ToString(), this.ActivityType.Value.ToString(), 
