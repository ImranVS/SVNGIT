...
{
    public partial class IBMConnectionBookmarksXtraRpt : DevExpress.XtraReports.UI.XtraReport
    {
        public IBMConnectionBookmarksXtraRpt()
        {
            InitializeComponent();
        }
        ...
        private void IBMConnectionForumsRptXtraRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            dt = VSWebBL.ReportsBL.ReportsBL.Ins.GetIBMConnectionstatsInfo(this.ServerName.Value.ToString(), BType,
