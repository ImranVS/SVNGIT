<%@ Page Title="VitalSigns Plus - Traveler Allocated Java memory" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Javamemory.aspx.cs" Inherits="VSWebUI.Javamemory" %>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="lblsmallFont" 
                                    Text="(will filter the report by Allocated Java memory above the entered value)">
                                </dx:ASPxLabel>
