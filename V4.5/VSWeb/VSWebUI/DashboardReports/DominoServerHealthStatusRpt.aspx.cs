...
{
    public partial class DominoServerHealthStatusRpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            DashboardReports.DominoServerHealthStatusXtraRpt report = new DashboardReports.DominoServerHealthStatusXtraRpt();
