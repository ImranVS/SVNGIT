<%@ Page Title="VitalSigns Plus - Cost Per User Served" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="CostPerUserServed.aspx.cs" Inherits="VSWebUI.DashboardReports.CostPerUserServed" %>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"  >
                <ContentTemplate>
                    <dx:ASPxPivotGrid ID="CostPerUserPivotGrid" runat="server" 
                        ClientIDMode="AutoID" EnableTheming="True" Theme="Office2003Blue"  OnUnload="CostPerUserPivotGrid_Unload"
                        >
                        <Fields>
            ...
            <dx:ASPxPivotGridExporter ID="ServerGridViewExporter" ASPxPivotGridID="CostPerUserPivotGrid" runat="server">
