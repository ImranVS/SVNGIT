<%@ Page Language="C#" Title="VitalSigns Plus - IBM Connection Files" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="IBMConnectionFileRpt.aspx.cs" Inherits="VSWebUI.DashboardReports.IBMConnectionFileRpt" %>
    ...
    <table>
            <tr>
                <td class="tdpadded" valign="top">
                    ...
                    <tr>
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="File Type:" CssClass="lblsmallFont">
                            </dx:ASPxLabel>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <dx:ASPxComboBox ID="FileTypeComboBox" runat="server" ValueType="System.String" 
                                onselectedindexchanged="FileTypeComboBox_SelectedIndexChanged">
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
                    </table>
