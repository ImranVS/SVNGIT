<%@ Page Title="VitalSigns Plus - EXJournal Document Totals" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="EXJournalDocumentTotals.aspx.cs" Inherits="VSWebUI.EXJournalDocumentTotals" %>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="lblsmallFont" 
                                    Text="(will filter the report by document total above the entered value)">
                                </dx:ASPxLabel>
