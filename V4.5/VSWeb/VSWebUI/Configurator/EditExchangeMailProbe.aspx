<%@ Page Title="VitalSigns Plus-Edit ExchangeMailProbe" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditExchangeMailProbe.aspx.cs" Inherits="VSWebUI.EditExchangeMailProbe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <div class="header" id="lblServer" runat="server">ExchangeMail Probe</div>
        </td>
    </tr>
    <tr>
        <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxTextBox ID="SendToTextBox" runat="server" Width="170px">
																						...
																						<RequiredField ErrorText="Enter Email" IsRequired="true" />
...
<RegularExpression ErrorText="Please Enter Valid Email" ValidationExpression="\w+([-+.&#39;]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></RegularExpression>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    <dx:ASPxLabel ID="ASPxLabel6" runat="server" 
                                                                                        Text="Attach File:" CssClass="lblsmallFont" Visible="False">
                                                                                    </dx:ASPxLabel>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <dx:ASPxLabel ID="ASPxLabel30" runat="server" Text="Attachment:" 
                                                                                        Visible="False">
                                                                                    </dx:ASPxLabel>
                                                                                </td>
                                                                                <td>
                                                                                    <dx:ASPxHyperLink ID="FilePathHyperLink" runat="server" Target="_blank" 
                                                                                        Text="FilePath" Visible="False">
                                                                                    </dx:ASPxHyperLink>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxTextBox ID="ScanIntervalTextBox" runat="server" 
                                                                                        AllowSpinOnMouseWheel="false" CssClass="txtsmall">
...
<RequiredField IsRequired="True"></RequiredField>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxTextBox ID="offScanTextBox" runat="server" 
                                                                                        AllowSpinOnMouseWheel="false" CssClass="txtsmall">
