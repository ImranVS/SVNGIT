<%@ Page Title="VitalSigns Plus - Exchange Mail Probes" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="ExchangeMailProbe.aspx.cs" Inherits="VSWebUI.Configurator.ExchangeMailProbe" %>
        ...
        <tr>
            <td>
                <div class="header" id="lblServer" runat="server">
                    ExchangeMail Probes</div>
            </td>
        </tr>
        <tr>
            <td valign="top">
                <div class="info">
                    ExchangeMail Probes send a text message from a specified server to a ExchangeMail
                    Address. Then the mail file of the recipient is checked to verify that the message
                    has arrived and to see how long it took. ExchangeMail Probes are useful for spotting
                    trends in delivery times and successful message delivery.
                </div>
                            ...
                            <ContentCollection>
                                <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <dx:ASPxGridView ID="ExchangeMailProbeGridView" runat="server" AutoGenerateColumns="False"
                                                    KeyFieldName="Name" OnHtmlRowCreated="ExchangeMailProbeGridView_HtmlRowCreated"
                                                    OnRowDeleting="ExchangeMailProbeGridView_RowDeleting" Width="100%" EnableTheming="True"
                                                    Theme="Office2003Blue" OnPageSizeChanged="ExchangeMailProbeGridView_PageSizeChanged">
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="ExchangeMail Address" ShowInCustomizationForm="True"
                                                            VisibleIndex="7" FieldName="ExchangeMailAddress">
                                                            <EditCellStyle CssClass="GridCss">
                                                            </EditCellStyle>
                                                            <EditFormCaptionStyle CssClass="GridCss">
                                                            </EditFormCaptionStyle>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Off-Hours Scan Interval" ShowInCustomizationForm="True"
                                                            VisibleIndex="8" FieldName="OffHoursScanInterval">
															<Settings AutoFilterCondition="Contains" AllowAutoFilterTextInputTimer="False" />
                                                            <EditCellStyle CssClass="GridCss">
                                                            </EditCellStyle>
                                                            <EditFormCaptionStyle CssClass="GridCss">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Retry Interval" ShowInCustomizationForm="True"
                                                            VisibleIndex="9" FieldName="RetryInterval">
															<Settings AutoFilterCondition="Contains" AllowAutoFilterTextInputTimer="False" />
                                                            <EditCellStyle CssClass="GridCss">
                                                            </EditCellStyle>
                                                            <EditFormCaptionStyle CssClass="GridCss">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Scan Interval" ShowInCustomizationForm="True"
                                                            VisibleIndex="10" FieldName="ScanInterval">
															<Settings AutoFilterCondition="Contains" AllowAutoFilterTextInputTimer="False" />
                                                            <EditCellStyle CssClass="GridCss">
                                                            </EditCellStyle>
                                                            <EditFormCaptionStyle CssClass="GridCss">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Source" ShowInCustomizationForm="True" VisibleIndex="11"
                            ...
                            <ContentCollection>
                                <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                    <table width="100%">
                                        <tr>
                                            <td width="100%">
                                                <dx:ASPxGridView ID="ExchangeMailProbeHistoryGridView" runat="server" AutoGenerateColumns="False"
                                                    CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css" CssPostfix="Office2010Silver"
                                                    Width="100%" Theme="Office2003Blue" OnPageSizeChanged="ExchangeMailProbeHistoryGridView_PageSizeChanged">
                                                    <Columns>
