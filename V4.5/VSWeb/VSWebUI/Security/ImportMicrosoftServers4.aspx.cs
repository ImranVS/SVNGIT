...
{
	public partial class ImportMicrosoftServers4 : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("~/Security/ImportMicrosoftServers.aspx", false);//Mukund, 05Aug14, VSPLUS-844:Page redirect on callback
			Context.ApplicationInstance.CompleteRequest();
		}
