<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="ImportExchangeServers2.aspx.cs" Inherits="VSWebUI.Security.ImportExchangeServers2" %>
...
<MaskSettings Mask="&lt;0..9999&gt;"></MaskSettings>
                            ...
                            <td>
                               <dx:ASPxComboBox ID="CredentialsComboBox" runat="server" AutoPostBack="false"  CssClass="txtmed" ></dx:ASPxComboBox>
                            </td>
					...
					<table>
                        <tr>
						 <td>
                                <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="Reply Q Threshold:" 
                                                                                CssClass="lblsmallFont">
                                                                            </dx:ASPxLabel>
                            </td>
                            <td>
...
<RequiredField IsRequired="True" ErrorText="Please enter the failure threshold.  How many times can the server be down before an alert is sent?"></RequiredField>
                            ...
                            <td>
                                <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Select Secondary Exchange Server:" 
                                                                                CssClass="lblsmallFont">
                                                                            </dx:ASPxLabel>
                            </td>
                            <td>
						  ...
						  <td>
                                <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Copy Q Threshold:" 
                                                                                CssClass="lblsmallFont">
                                                                            </dx:ASPxLabel>
                            </td>
                            <td>
...
<RequiredField IsRequired="True" ErrorText="Please enter the failure threshold.  How many times can the server be down before an alert is sent?"></RequiredField>
						 ...
						 <td>
                                <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Select Primary Exchange Server:" 
                                                                                CssClass="lblsmallFont">
                                                                            </dx:ASPxLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="left">
                                <dx:ASPxButton ID="AssignButton" runat="server" OnClick="AssignButton_Click" 
                                    Text="Next" Theme="Office2010Blue" Width="60px">
                                </dx:ASPxButton>
                            </td>
                        </tr>
    </table>
