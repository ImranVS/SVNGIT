<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="ImportServers4.aspx.cs" Inherits="VSWebUI.Security.ImportServers4" %>
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                            <dx:ASPxButton ID="ImportAddlButton" runat="server" CssClass="sysButton"
                    OnClick="ImportAddlButton_Click" Text="Import Additional Servers">
                </dx:ASPxButton>
                        </td>
                        <td>
                            <dx:ASPxButton ID="DoneButton" runat="server" CssClass="sysButton"
