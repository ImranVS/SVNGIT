<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotesSearch.aspx.cs" Inherits="CustomerTracking.NotesSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxRoundPanel ID="SearchNotesRoundPanel" runat="server" Width="100%"
    CssPostfix="Glass" HeaderText="Search Notes" Theme="Office2003Blue">
...
<Paddings PaddingBottom="0px" PaddingLeft="2px" PaddingTop="0px"></Paddings>
    ...
    <dx:ASPxGridView ID="NotesSearchGridView" runat="server" 
                            ...
                            EnableTheming="True" OnPageSizeChanged="NotesGridView_PageSizeChanged">
                            <Columns>
