#D:\Mukund\E\RPRWyatt\VSTrunk\PowerShell_POC\PSPOC1\bin\Debug\Scripts\EX_MailBoxReportByServer.ps1

$report = @()
#$server = 'win-kurrr2qsdj0.jnittech.com'

$sortedStats = Get-Mailbox -ResultSize Unlimited | Get-MailboxStatistics | Sort-Object TotalItemSize -Descending| Select-Object DisplayName, RecipientTypeDetails, ServerName, Database, TotalDeletedItemSize,ItemCount,LastLogonTime, `
