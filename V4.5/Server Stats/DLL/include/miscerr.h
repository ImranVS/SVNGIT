...
#define ERR_MUI_DIR_NOTFOUND				(PKG_MISC2+26)
	errortext(ERR_MUI_DIR_NOTFOUND,			"The Language specified for the User interface is not found in your Notes\MUI directory (may have been uninstalled); proceeding with the default installed language.")
