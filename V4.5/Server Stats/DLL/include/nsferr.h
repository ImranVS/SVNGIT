...
/* these were old db2 prototype error messages and have been recycled in 7.02 */
...
#define ERR_USER_NAME_TOO_LONG				PKG_NSF9+120
	errortext(ERR_USER_NAME_TOO_LONG,		"User name exceeds maxinum size, Access denied to DB %p ")


/* Available PKG_NSF9+121 - 123 */
...
#define STR_DB2_ACCESS_SET_STEPS	PKG_DB2_STR+53
    stringtext(STR_DB2_ACCESS_SET_STEPS,"DB2 Access Set: %s\n|Updating server document.|Updating notes.ini.|Dropping deprecated functions.|Adding new functions.|Adding connection document.|Testing connection from DB2 Access.")
#define IDX_DB2_ACCESS_STEP_SET				1
#define IDX_DB2_ACCESS_STEP_UPDT_SRV_DOC	2
#define IDX_DB2_ACCESS_STEP_UPDT_NOTES_INI	3
