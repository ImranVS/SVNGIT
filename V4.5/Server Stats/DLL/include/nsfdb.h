...
STATUS LNPUBLIC NSFBackupStartApplyChangeInfoWithCallback(HANDLE *ApplyInfoContext,
...
STATUS far PASCAL NSFGetChangedDBs(char *ServerName, TIMEDATE *SinceTime, DWORD *ChangesSize, HANDLE *hChanges, TIMEDATE *NextSinceTime);
