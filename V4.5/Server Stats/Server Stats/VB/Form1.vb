...
#End Region
    ...
    '********************************************************
    Dim mNotesProgDir As String = "C:\Program Files (x86)\IBM\Lotus\Notes"
    Dim mNotesINI As String = "=C:\Program Files (x86)\IBM\Lotus\Notes\notes.ini"             ' *** Must start with "=" ***
    Dim mUserId As String = "C:\Program Files (x86)\IBM\Lotus\Notes\data\aforbesRPR.id"
