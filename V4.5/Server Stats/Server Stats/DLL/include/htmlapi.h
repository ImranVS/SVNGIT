 ...
 *	Arguments can be supplied to the convert note that augment and modify the conversion.
 ...
 *    Document note                   OpenDocument
 *    Form note                       OpenForm (non-post HTML generated)
 *    Frameset note                   OpenFrameset
 *    Help note                       OpenHelp
 *    Help-about note                 OpenAbout
 *    Icon note                       OpenIcon
 *    Navigator note                  OpenNavigator
 *    Page note                       OpenPage
 *    View note                       OpenView (unexpanded top level of view, all entries)
