...
#define ERR_CMD_DB2_INFOSTR2   			PKG_SERVER7+98
	stringtext(ERR_CMD_DB2_INFOSTR2,   	"Schema Version:|DB2 Access Server:|DB2 Access Path:|Default Datastore:|DB2 Purge Interval:|Day(s)|Connections:|{default DB2 function directory}|MAX NSFs per Group:")
#define ERR_CMD_DB2_CATALOG				PKG_SERVER7+99
	stringtext(ERR_CMD_DB2_CATALOG,		"CATALOG")
/*	available							PKG_SERVER7+100 */
...
#define STR_CMD_DB2GROUP_SETSTATE						PKG_SERVER_STR+18
	stringtext(STR_CMD_DB2GROUP_SETSTATE,				"SETSTATE ""group name"" ""lock/open""")
