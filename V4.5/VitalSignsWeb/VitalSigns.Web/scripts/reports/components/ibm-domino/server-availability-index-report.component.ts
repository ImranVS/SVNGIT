...
@Component({
    templateUrl: '/app/reports/components/ibm-domino/server-availability-index-report.component.html',
    providers: [
        WidgetService,
        RESTService
    ]
})
export class ServerAvailabilityIndexReport extends WidgetController {
