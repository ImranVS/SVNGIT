...
@Component({
    templateUrl: '/app/reports/components/ms-exchange/ms-exchange-memory-percentage.component.html',
    providers: [
        WidgetService,
        RESTService,
...
export class memorypercentagereport extends WidgetController {
    ...
    currentWidgetName: string = `memorychart`;
