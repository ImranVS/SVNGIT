...
export class WebSphereServerImport extends GridBase implements OnInit {
    ...
    delteCellInfo() {
        this.deleteGridRow('/configurator/delete_cellInfo/','This Cell should NOT be deleted if any servers within the cell are being monitored.Are you sure want to delete this record?');
    }
