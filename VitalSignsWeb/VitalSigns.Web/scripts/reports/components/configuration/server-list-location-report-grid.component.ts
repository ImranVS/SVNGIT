...
@Component({
    ...
    templateUrl: './app/reports/components/configuration/server-list-location-report-grid.component.html',
    providers: [
        HttpModule,
        RESTService,
...
export class ServerListLocationReportGrid implements WidgetComponent, OnInit {
    ...
    set pageSize(value: number) {
        if (this.data.pageSize != value) {
            ...
            this.data.refresh();
            var obj = {
                name: this.gridHelpers.getGridPageName("ServerListLocationReportGrid", this.authService.CurrentUser.email),
                value: value
            };
    ...
    onPropertyChanged(key: string, value: any) {
        ...
        if (key === 'gridUrl') {
            ...
            this.service.get(`/services/get_name_value?name=${this.gridHelpers.getGridPageName("ServerListLocationReportGrid", this.authService.CurrentUser.email)}`)
                .subscribe(
                (data) => {
