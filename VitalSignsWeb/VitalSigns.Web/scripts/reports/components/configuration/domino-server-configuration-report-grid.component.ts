...
@Component({
    ...
    templateUrl: './app/reports/components/configuration/domino-server-configuration-report-grid.component.html',
    providers: [
        HttpModule,
        RESTService
    ]
})
export class DominoServerConfigurationReportGrid implements WidgetComponent, OnInit {
