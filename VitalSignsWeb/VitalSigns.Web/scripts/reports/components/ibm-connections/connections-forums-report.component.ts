...
@Component({
    templateUrl: '/app/reports/components/ibm-connections/connections-forums-report.component.html',
    providers: [
        RESTService,
        helpers.UrlHelperService
    ]
})
export class ConnectionsForumsReport extends WidgetController {
    contextMenuSiteMap: any;
    widgets: WidgetContract[];
    statname: string;
    title: string;
    currentStatType: string = "NUM_OF_FORUMS";
    currentHideServerControl: boolean = false;
    currentHideDatePanel: boolean = false;
    currentDeviceType: string = "IBM Connections";
    currentWidgetName: string = `connectionsForums`;
    currentWidgetURL: string = `/reports/summarystats_chart?statName=NUM_OF_FORUMS_FORUMS`;
