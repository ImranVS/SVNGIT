...
@Component({
    templateUrl: '/app/reports/components/ibm-connections/connections-profiles-report.component.html',
    providers: [
        RESTService,
        helpers.UrlHelperService
    ]
})
export class ConnectionsProfilesReport extends WidgetController {
    contextMenuSiteMap: any;
    widgets: WidgetContract[];
    statname: string;
    title: string;
    currentStatType: string = "NUM_OF_PROFILE";
    currentHideServerControl: boolean = false;
    currentHideDatePanel: boolean = false;
    currentDeviceType: string = "IBM Connections";
    currentWidgetName: string = `connectionsProfiles`;
    currentWidgetURL: string = `/reports/summarystats_chart?statName=NUM_OF_PROFILES_PROFILES`;
