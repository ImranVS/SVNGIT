...
@Component({
    templateUrl: '/app/reports/components/ms-exchange/ms-exchange-cpuutil.component.html',
    providers: [
        WidgetService,
        RESTService,
...
export class exchangecpuutilreport extends WidgetController {
    ...
    currentWidgetName: string = `cpuutilchart`;
