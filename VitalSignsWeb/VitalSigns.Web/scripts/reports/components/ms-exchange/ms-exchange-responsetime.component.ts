...
@Component({
    templateUrl: '/app/reports/components/ms-exchange/ms-exchange-responsetime.component.html',
    providers: [
        WidgetService,
        RESTService,
...
export class exchangeresponsetimereport extends WidgetController {
    ...
    currentWidgetName: string = `responsechart`;
