...
@Component({
    templateUrl: '/app/reports/components/ibm-domino/server-access-browser-report.component.html',
    providers: [
        WidgetService,
        RESTService
    ]
})
export class ServerAccessBrowserReport extends WidgetController {
