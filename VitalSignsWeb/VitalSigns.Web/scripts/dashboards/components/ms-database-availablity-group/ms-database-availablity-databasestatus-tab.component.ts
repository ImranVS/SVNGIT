...
@Component({
    ...
    templateUrl: '/app/dashboards/components/ms-database-availablity-group/ms-database-availablity-databasestatus-tab.component.html'
})

export class DatabaseStatusTab extends WidgetController implements OnInit, ServiceTab {
