...
@Component({
    templateUrl: './app/dashboards/components/ms-exchange/ms-exchange-queues-grid.component.html',
    providers: [
        HttpModule,
        RESTService,
        helpers.GridTooltip,
...
export class MSQueuesGrid implements WidgetComponent, OnInit {
    ...
    set pageSize(value: number) {
        if (this.data.pageSize != value) {
            ...
            this.data.refresh();
            var obj = {
                name: this.gridHelpers.getGridPageName("MSQueuesGrid", this.authService.CurrentUser.email),
                value: value
            };
