...
@Component({
    ...
    templateUrl: '/app/dashboards/components/key-metrics/key-metrics-alphabetical-grid.component.html',
    providers: [
        HttpModule,
        RESTService
    ]
})
export class KeyMetricsAlphabeticalGrid implements WidgetComponent, OnInit {
